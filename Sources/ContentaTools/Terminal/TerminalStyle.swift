...
public typealias StyleCode = (open: UInt8, close: UInt8)

public struct Terminal {
    public enum Code {
        case crtl(UInt8)
        case color(UInt8)
        case style(UInt8, UInt8)
    }

    public static let reset = Code.crtl(0)

    public static let bold          = Code.style(1, 22)
    public static let dim           = Code.style(2, 22)
    public static let italic        = Code.style(3, 23)
    public static let underline     = Code.style(4, 24)
    public static let blink         = Code.style(5, 25)
    public static let reverse       = Code.style(7, 27)
    public static let hidden        = Code.style(8, 28)
    public static let strikethrough = Code.style(9, 29)
}
